...
{    screen=drawImage(menu.background,screen, 0, 0);
    ...
    screen=drawImage(menu.texte[0],screen, 10, 160);
    screen=drawImage(menu.texte[1],screen, 10, 200);
    screen=drawImage(menu.texte[2],screen,10, 240);
    screen=drawImage(menu.texte[3],screen, 10, 280);
    screen=drawImage(menu.texte[4],screen, 10, 420);
    SDL_Flip(screen);
    return screen;
}
